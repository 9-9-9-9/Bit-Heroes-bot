...
public class TrialsApp extends AbstractApplication {
    private final AttendablePlace ap = AttendablePlaces.trials;
    ...
    protected void internalRun(String[] args) {
        ...
        try (
            ...
            try {
                ...
                info(getHelp());
                loopCount = readInput(br, "Loop count:", "How many time do you want to do Trials", new Function<String, Tuple3<Boolean, String, Integer>>() {
                    @Override
